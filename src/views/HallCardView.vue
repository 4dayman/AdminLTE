<template>
    <content-header title="Карточка зала" icon="fas fa-info-circle" />
    <content>
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <div class="film_lang pr-4 mt-2">
                        <div class="custom-control custom-radio mr-2">
                            <input class="custom-control-input" type="radio" id="ua" value="0" name="lang"
                                @change="langChange"
                                v-model="this.$store.state.cinemas.cinemasList[id].halls.lang">
                        ...
                        <div class="film_name">
                            <div class="input-group mt-3">
                                ...
                                <input class="form-control ml-1" type="text" placeholder="Название кинотеатра"
                                    v-model.trim="this.$store.state.cinemas.cinemasList[id].halls.data[this.$store.state.cinemas.cinemasList[id].lang].title"
